package StandardProblemDSA.XIV_MATHS;
...
public class ModString {
  public static int findMod(String A, int B) {
    ...
    for (int i = 0; i < A.length(); i++) res = (res * 10 + (int) A.charAt(i) - '0') % B;
    ...
    // //                    IntegerValueOfStringA +=
    // (Character.getNumericValue(A.charAt(l))*Math.pow(10,n));
    // //                l=l+1;
    // //                n=n+1;
    // //            }
    // //            else{//43535321
    ...
    //                     // System.out.println(Character.getNumericValue(A.charAt(i)));
    //                     IntegerValueOfStringA +=
    // (Character.getNumericValue(A.charAt(i))*Math.pow(10,j));
    //                     i--;
    //                     j++;
