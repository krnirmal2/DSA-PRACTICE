...
public class EditDistance {
  /*Given two strings word1 and word2, return the minimum number of operations required to convert word1 to word2.
    ...
    LeetCode:
    - [LeetCode 72 – Edit Distance](https://leetcode.com/problems/edit-distance/) Done
  ...
  private int helper(String word1, String word2, int i, int j) {
    // TIP : START FROM THE BACK FOR BOTHE STRING AND IF MATCHED THEN REDUCED BOTH
    // ELSE DELETE ONE OF THEM OR INSERT ONE OF THEM AND DECREASE INDEX OR REPLACE WITH REDUCED BOTH
    // INDEX
    // Base cases
