...
public class SortCharByFrequency {
   ...
   *
   * <p>Given a string s, sort it in decreasing order based on the frequency of the characters. The
   * frequency of a character is the number of times it appears in the string. Return the sorted
   * string. If there are multiple valid answers, return any of them.
   *
   * <p>Examples: Input: s = "tree" Output: "eert" Explanation: 'e' appears twice while 'r' and 't'
   * both appear once. So 'e' must appear before both 'r' and 't'.
   *
   * <p>Input: s = "cccaaa" Output: "cccaaa" or "aaaccc" Explanation: Both 'c' and 'a' appear three
   * times, so both "cccaaa" and "aaaccc" are valid answers.
   *
   * <p>Input: s = "Aabb" Output: "bbAa" or "bbaA" Explanation: 'b' appears twice, 'A' and 'a' once
   * each. 'A' and 'a' are treated as different characters.
   *
