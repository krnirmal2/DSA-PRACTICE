...
public class CompareVersionNumbers {
  ...
  *
  * Follow-up:
  * - Can be done in O(1) extra space by parsing numbers on the fly.
  * - Handle extremely large version numbers by comparing digits without parsing to int.
  *
  * LeetCode Similar: 165. Compare Version Numbers
   */
