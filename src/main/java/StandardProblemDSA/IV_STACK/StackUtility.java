...
public class StackUtility {
    ...
    /**
     * Reverses a given stack recursively.
     * This method modifies the input stack such that the order of elements is reversed.
     *
     ...
     * This method is applicable to stacks of integers.
     *
    ...
    /**
     * Helper method for sorted insertion into a stack.
     * It inserts an element into the sorted stack such that the stack remains sorted.
     *
     ...
     * Note: This prints elements in the order as they are stored in the stack.
     *
