...
public class IsBridgePresentOrNot {
  ...
  public static class Graphs {
    ...
    public static void addEdge(ArrayList<ArrayList<Integer>> adjcencyList, int u, int v) {
      adjcencyList.get(u).add(v);
      adjcencyList.get(v).add(u);
    }

    public static void removeEdge(ArrayList<ArrayList<Integer>> adjcencyList, int src, int dest) {
